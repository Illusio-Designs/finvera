module.exports = (sequelize, DataTypes) => {
  const SubscriptionPlan = sequelize.define(
    'SubscriptionPlan',
    {
      ...
      max_companies: { type: DataTypes.INTEGER, defaultValue: 1, comment: 'Maximum number of companies allowed' },
      max_branches: { type: DataTypes.INTEGER, defaultValue: 0, comment: 'Maximum number of branches allowed (0 = no branches)' },
