 ...
 * - Master Database (finvera_master): tenant_master, companies, hsn_sac_master, tenant_reviews, subscriptions, payments
...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    // 3. HSN_SAC_MASTER TABLE (in master DB)
    ...
    // 4. TENANT_REVIEWS TABLE (in master DB)
  ...
  async down(queryInterface, Sequelize) {
    ...
    await queryInterface.dropTable('hsn_sac_master');
