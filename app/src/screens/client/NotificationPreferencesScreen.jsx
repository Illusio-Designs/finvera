...
export default function NotificationPreferencesScreen() {
  ...
  const testNotification = async (type) => {
    try {
      if (type === 'push') {
        await notificationAPI.test.push();
        Alert.alert('Test Sent', 'Push notification test sent successfully');
      } else if (type === 'email') {
        await notificationAPI.test.email();
        Alert.alert('Test Sent', 'Email notification test sent successfully');
      }
    } catch (error) {
