...
export default function CompaniesScreen() {
  ...
  const handleCompanyPress = (company) => {
    Alert.alert('Company Details', `View details for ${company.company_name || company.name}`);
  };

  const handleCreateCompany = () => {
    Alert.alert('Create Company', 'Create new company functionality will be available soon');
  };
