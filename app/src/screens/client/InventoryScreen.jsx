...
export default function InventoryScreen() {
  ...
  const handleItemPress = (item) => {
    Alert.alert('Item Details', `View details for ${item.name}`);
  };

  const handleCreateItem = () => {
    Alert.alert('Create Item', 'Create new inventory item functionality will be available soon');
  };

  const handleAdjustment = () => {
    Alert.alert('Stock Adjustment', 'Stock adjustment functionality will be available soon');
  };

  const handleTransfer = () => {
    Alert.alert('Stock Transfer', 'Stock transfer functionality will be available soon');
  };
