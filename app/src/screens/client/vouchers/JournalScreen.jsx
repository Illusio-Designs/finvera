...
export default function JournalScreen() {
  ...
  const fetchVouchers = useCallback(async () => {
    ...
    try {
      ...
      console.error('journal vouchers fetch error:', error);
      showNotification({
        type: 'error',
        title: 'Error',
        message: 'Failed to load journal vouchers'
      });
      setVouchers([]);
    } finally {
  ...
  return (
    <View style={styles.container}>
      <TopBar title="journal Vouchers" onMenuPress={handleMenuPress} />
      ...
      >
        <View style={styles.headerActions}>
          <TouchableOpacity style={styles.createButton} onPress={handleCreatejournal}>
        ...
        {loading ? (
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtitle}>
              Click "New journal" button above to create your first journal voucher
            </Text>
          </View>
        ) : (
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>
              {selectedVoucher?.voucher_number || 'journal Details'}
            </Text>
            ...
            {selectedVoucher && (
              <View style={styles.detailContainer}>
                <View style={styles.infoSection}>
                  <Text style={styles.infoSectionTitle}>journal Information</Text>
