...
import CreateContraModal from '../../../components/modals/CreateContraModal';
...
export default function ContraScreen() {
  ...
  const fetchVouchers = useCallback(async () => {
    ...
    try {
      ...
      console.error('contra vouchers fetch error:', error);
      showNotification({
        type: 'error',
        title: 'Error',
        message: 'Failed to load contra vouchers'
      });
      setVouchers([]);
    } finally {
  ...
  const handleDeleteVoucher = () => {
    showNotification({
      type: 'info',
      title: 'Coming Soon',
      message: 'Delete contra feature coming soon'
    });
  };
  ...
  return (
    <View style={styles.container}>
      <TopBar title="contra Vouchers" onMenuPress={handleMenuPress} />
      ...
      >
        <View style={styles.headerActions}>
          <TouchableOpacity style={styles.createButton} onPress={handleCreatecontra}>
            <Ionicons name="add" size={16} color="white" />
            <Text style={styles.createButtonText}>New contra</Text>
          </TouchableOpacity>
        </View>
        ...
        {loading ? (
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyTitle}>No contras Found</Text>
            <Text style={styles.emptySubtitle}>
              Click "New contra" button above to create your first contra voucher
            </Text>
          </View>
        ) : (
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>
              {selectedVoucher?.voucher_number || 'contra Details'}
            </Text>
            ...
            {selectedVoucher && (
              <View style={styles.detailContainer}>
                <View style={styles.infoSection}>
                  <Text style={styles.infoSectionTitle}>contra Information</Text>
      ...
      <CreateContraModal
        ...
        onContraCreated={handleContraCreated}
        editMode={editMode}
