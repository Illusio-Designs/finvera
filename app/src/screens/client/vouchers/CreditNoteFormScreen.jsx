...
export default function CreditNoteFormScreen() {
  ...
  const handleItemCreated = (newItem) => {
    ...
    showNotification({
      type: 'success',
      title: 'Success',
      message: 'Item created and added to credit note successfully'
    });
  };
  ...
  const handleSave = async (status = 'draft') => {
    ...
    try {
      ...
      const response = await voucherAPI.creditNote.create(payload);
      ...
      showNotification({
        type: 'success',
        title: 'Success',
        message: `Credit note ${status === 'draft' ? 'saved as draft' : 'posted'} successfully`
      });
      ...
      console.log('🎉 === CREDIT NOTE SAVE COMPLETED ===\n');
      ...
      showNotification({
        type: 'error',
        title: 'Error',
        message: error.response?.data?.message || 'Failed to save credit note'
      });
      console.log('💔 === CREDIT NOTE SAVE FAILED ===\n');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleEInvoiceGenerate = async () => {
    if (!savedVoucherId) {
      showNotification({
        type: 'error',
        title: 'Error',
        message: 'Please save the credit note first'
      });
      return;
    }
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        {pageLoading ? (
          ...
          <>
            ...
            <View style={styles.headerCard}>
              <View style={styles.headerRow}>
                <View style={styles.headerInfo}>
                  ...
                  <Text style={styles.headerSubtitle}>Create new credit note</Text>
                </View>
            ...
            {formData.items.length > 0 && (
              <View style={styles.section}>
                <Text style={styles.sectionTitle}>Credit Note Summary</Text>
