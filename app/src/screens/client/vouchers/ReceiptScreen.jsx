...
export default function ReceiptScreen() {
  ...
  const fetchVouchers = useCallback(async () => {
    ...
    try {
      ...
      console.error('Receipt vouchers fetch error:', error);
      showNotification({
        type: 'error',
        title: 'Error',
  ...
  return (
    <View style={styles.container}>
      <TopBar title="Receipt Vouchers" onMenuPress={handleMenuPress} />
      ...
      >
        <View style={styles.headerActions}>
          <TouchableOpacity style={styles.createButton} onPress={handleCreateReceipt}>
            <Ionicons name="add" size={16} color="white" />
            <Text style={styles.createButtonText}>New Receipt</Text>
          </TouchableOpacity>
        </View>
        ...
        {loading ? (
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtitle}>
              Click "New Receipt" button above to create your first receipt voucher
            </Text>
          </View>
        ) : (
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>
              {selectedVoucher?.voucher_number || 'Receipt Details'}
            </Text>
            ...
            {selectedVoucher && (
              <View style={styles.detailContainer}>
                <View style={styles.infoSection}>
                  <Text style={styles.infoSectionTitle}>Receipt Information</Text>
