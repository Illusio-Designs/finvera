...
export default function DebitNoteScreen() {
  ...
  const fetchVouchers = useCallback(async () => {
    ...
    try {
      ...
      console.error('debit_note vouchers fetch error:', error);
      showNotification({
        type: 'error',
        title: 'Error',
        message: 'Failed to load debit_note vouchers'
      });
      setVouchers([]);
    } finally {
  ...
  const handleCreatedebit_note = () => {
    showNotification({
      type: 'info',
      title: 'Coming Soon',
      message: 'Create debit_note feature coming soon'
    });
  };
  ...
  const handleEditVoucher = () => {
    showNotification({
      type: 'info',
      title: 'Coming Soon',
      message: 'Edit debit_note feature coming soon'
    });
  };
  ...
  const handleDeleteVoucher = () => {
    showNotification({
      type: 'info',
      title: 'Coming Soon',
      message: 'Delete debit_note feature coming soon'
    });
  };
  ...
  return (
    <View style={styles.container}>
      <TopBar title="debit_note Vouchers" onMenuPress={handleMenuPress} />
      ...
      >
        <View style={styles.headerActions}>
          <TouchableOpacity style={styles.createButton} onPress={handleCreatedebit_note}>
            <Ionicons name="add" size={16} color="white" />
            <Text style={styles.createButtonText}>New debit_note</Text>
          </TouchableOpacity>
        </View>
        ...
        {loading ? (
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyTitle}>No debit_notes Found</Text>
            <Text style={styles.emptySubtitle}>
              Click "New debit_note" button above to create your first debit_note voucher
            </Text>
          </View>
        ) : (
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>
              {selectedVoucher?.voucher_number || 'debit_note Details'}
            </Text>
            ...
            {selectedVoucher && (
              <View style={styles.detailContainer}>
                <View style={styles.infoSection}>
                  <Text style={styles.infoSectionTitle}>debit_note Information</Text>
