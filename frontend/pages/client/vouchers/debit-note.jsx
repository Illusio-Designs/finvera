...
export default function DebitNotePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Create debit note using generic voucher endpoint
      ...
      const errorMessage = error.response?.data?.message || error.response?.data?.error || 'Failed to create debit note';
          ...
          actions={
            <div className="flex gap-2">
              ...
              >
                ...
                <span>{loading ? 'Saving...' : 'Save Debit Note'}</span>
              </Button>
            </div>
          }
        >
