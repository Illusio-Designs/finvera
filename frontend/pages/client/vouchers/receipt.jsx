...
export default function ReceiptPage() {
  ...
  // Filter for party ledgers (customers/debtors) and bank/cash ledgers
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await accountingAPI.receipts.create({
      ...
      const errorMessage = error.response?.data?.message || error.response?.data?.error || 'Failed to create receipt voucher';
  ...
  return (
    <ProtectedRoute portalType="client">
      <ClientLayout title="Receipt Voucher">
        <PageLayout
