...
export default function SalesmenList() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Salesman code: optional on create (auto-generated by backend), required on edit
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormInput
                    name="salesman_code"
                    label="Salesman Code (leave blank to auto-generate)"
                    ...
                    placeholder="e.g. SALE001 (or leave blank)"
                  />
