...
export default function DistributorsList() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Distributor code: optional on create (auto-generated by backend), required on edit
    if (modalMode === 'edit' && !formData.distributor_code.trim()) {
    ...
    try {
      ...
      if (modalMode === 'create' && !payload.distributor_code?.trim()) {
